...
def create_app(test_config=None):
    ...
    def retrieve_cat_questions(category_id):
        ...
        category = Category.query\
            .filter(Category.id == category_id).one_or_none().type
        # return success message with matching questions
        return jsonify({
            'success': True,
            'questions': current_questions,
    ...
    def play_quiz():
        ...
        try:
            ...
            # Since previous_questions is just a list of ids
            # we can simply filter on these ids
            questions = Question.query.order_by(Question.id)\
            ...
            # Frontend can deal with this
            # just need to return a success message
            if len(questions) == 0:
                return jsonify({
                    'success': True
                })
